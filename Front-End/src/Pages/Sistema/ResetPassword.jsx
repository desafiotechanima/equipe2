...
import {forgotPassword} from "../../Api/ApiAxios";
...
const ResetPassword = props => {
    ...
    return (
        <>
          <img src={Logo}style={{height:150, marginTop:320}} alt='Zoe'/>
            ...
            >
                <Toast style={{
                    ...
                    <Toast.Header>
                        <img style={{height: "30px", width: "100px"}} src={require("../../assets/img/argon-react.png").default}  alt="..."/>
                    </Toast.Header>
                    <Toast.Body>
                        {toastMessage}
                        {config.DEMO ?
            ...
            >
                    <CardBody className="px-lg-5 py-lg-5">
                        <Form role="form">
                            ...
                            <Button color="primary" type="button" onClick={sendEmail}>
                                    Redefinir Senha
                                </Button>
                            {error ?
